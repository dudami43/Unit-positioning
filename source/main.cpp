...
int main()
{
    ...
    read_map(weight_matrix, imp_matrix, flags_matrix, distances, n_units, "instances/vicosa15.txt");
    ...
    std::vector<int> solution1 = greedy(n_units, distances, imp_vector, "random_1");

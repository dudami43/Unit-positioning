...
int main()
{
    ...
    std::cout << "Com as importâncias\n" << objectiveFunction(distances, imp_matrix, solution, true) << std::endl;
    std::cout << "Sem as importâncias\n" << objectiveFunction(distances, imp_matrix, solution, false) << std::endl;

    std::vector<int> solution2;
    greedySolution(10, distances, imp_matrix, solution2);
    std::cout << "Sem as importâncias2\n" << objectiveFunction(distances, imp_matrix, solution2, false) << std::endl;
